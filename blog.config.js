...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '17fa0a9b2ff18068bb5af179874e54df,en:17fa0a9b2ff18068bb5af179874e54df',
  THEME: process.env.NEXT_PUBLIC_THEME || 'marine', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'luomarine', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'marine equipment', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://luomarine.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'marine equipment', // 网站关键词 英文逗号隔开
